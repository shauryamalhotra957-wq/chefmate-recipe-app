# chefmate-recipe-app: Production Operations Runbook & Incident Triage

Production guidance, offline cache lifecycle, and incident playbooks for **Smart Recipe Recommendation & Interactive Cooking Assistant**.
